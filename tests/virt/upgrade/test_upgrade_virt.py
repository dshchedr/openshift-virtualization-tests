...
class TestUpgradeVirt:
    ...
    def test_is_vm_running_before_upgrade(self, vms_for_upgrade, vms_boot_time_before_upgrade):
    ...
    def test_is_vm_running_after_upgrade(self, vms_for_upgrade, vms_boot_time_before_upgrade):
        for vm in vms_for_upgrade:
            vm.vmi.wait_until_running()
        verify_vms_boot_time(vm_list=vms_for_upgrade, initial_boot_time=vms_boot_time_before_upgrade)
